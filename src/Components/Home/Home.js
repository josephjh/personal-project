      ...
      return (
        <div id='body' className="Home">
          ...
          <div className='container'>
            ...
            <Link to='/products?search=sound system'><img className='category' src='https://cdn.shopify.com/s/files/1/0790/9773/collections/Sound_System_Icon_-_Home.png?v=1531583590' alt='Sound System'/></Link>
